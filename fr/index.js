...
const TEXT = {
  // common text
  TITLE: 'Installer comme application', // Install as an app
  ...
  IOS: {
    ...
    INSTALL_STEPS: {
      STEP_1_1: 'Cliquez sur l\'icône', // Click the icon
      STEP_1_2: 'dans la barre d\'adresse du navigateur.', // in the browser address bar.
      STEP_2: 'Cliquez sur "Ajouter à l\'écran d\'accueil".', // Click 'Add to Home Screen'.
    }
  },
}
